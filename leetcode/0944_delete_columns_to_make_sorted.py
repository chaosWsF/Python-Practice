...
is in non-decreasing sorted order. Return the minimum possible value of D.length.
...
Example 1:
    ...
    Explanation: 
        ...
        sorted order. If we chose D = {}, then a column ["b","a","h"] would not be in non-decreasing 
        sorted order.
...
class Solution:
    def minDeletionSize(self, A):
        ...
        return sum(helper(l) for l in zip(*A))
