...
cells (r1, c1) and (r2, c2) is the Manhattan distance, |r1 - r2| + |c1 - c2|. (You 
...
Example 2:
    ...
    Explanation: The distances from (r0, c0) to other cells are: [0,1,1,2]. The answer 
...
Example 3:
    ...
    Explanation: The distances from (r0, c0) to other cells are: [0,1,1,2,2,3]. There 
                 are other answers that would also be accepted as correct, such as 
